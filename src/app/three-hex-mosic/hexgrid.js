...
(vg.Board = function(e, t) {
  ...
  (vg.SqrGrid.prototype = {
    ...
    generate: function(e) {
      ...
      for (t = -n; n > t; t++)
        for (i = -n; n > i; i++) (s = new vg.Cell(t, i + 1)), this.add(s);
    },
    generateOverlay: function(e, t, i) {
      var s,
        n,
    ...
    (t.generateID = function() {
      ...
      (t.prototype = {
        ...
        addNode: function(i) {
          ...
          return (
            (s.obj = i), (s.free = !1), (this.objToNodeMap[i.uniqueID] = s), s
          );
        },
        ...
        add: function(e) {
          ...
          if (this.first) {
            ...
            (this.first = t), (this.last = t), (t.next = null), (t.prev = null);
  ...
  (function() {
    ...
    (t.prototype = {
      ...
      _registerListener: function(t, i, s, n) {
        ...
        return (
          this.memorize && this._prevParams && l.execute(this._prevParams), l
        );
      },
      ...
      _indexOfListener: function(e, t) {
        for (var i, s = this._bindings.length; s--; )
          if (((i = this._bindings[s]), i._listener === e && i.context === t))
            return s;
        return -1;
      },
      has: function(e, t) {
      ...
      add: function(e, t, i) {
        return (
          this.validateListener(e, "add"), this._registerListener(e, !1, t, i)
        );
      },
  ...
  (vg.AStarFinder.prototype = {
    findPath: function(e, t, i, s) {
      ...
      for (
        ...
        for (
          r = s.getNeighbors(n, this.allowDiagonal, i), o = 0, a = r.length;
          a > o;
          o++
        )
          if (
  ...
  (vg.PathUtil = {
    ...
    compressPath: function(e) {
      ...
      var t,
        ...
        g = u - a;
      for (
        l = Math.sqrt(d * d + g * g), d /= l, g /= l, h.push([o, a]), r = 2;
        r < e.length;
        r++
      )
        (t = c),
