...
@Component({
  selector: "app-three-primordial-soup",
  templateUrl: "./three-primordial-soup.component.html",
  styleUrls: ["./three-primordial-soup.component.css"]
})
export class ThreePrimordialSoupComponent implements OnInit {
  scene;
  camera;
  renderer;
  uniforms;
  ...
  update() {
    ...
    this.uniforms.u_time.value +=
      0.05 * (1 + this.uniforms.u_mouse.value.x / 200);
